...
#%%
path_result = "results/lstm/timestep_%d/lb=%d_la=%d_ne1=%d_ne2=%d_ne=%d/"%(timestep, look_back,look_ahead,neuron1, neuron2, neuron3)
...
columns=["look_back", "look_ahead", "neuron1", "neuron2", "neuron3"] + ["MAPE: %d Step"%i for i in range(1,look_ahead+1)]
